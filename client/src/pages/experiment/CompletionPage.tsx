    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-lg max-w-lg w-full overflow-hidden text-center">
          ...
          <h1 className="text-2xl font-bold">Session Terminated</h1>
          <p className="text-red-200 text-sm mt-1">实验已终止</p>
          </div>
          <div className="p-8 space-y-4">
            ...
            <div className="mt-4 p-3 bg-slate-50 rounded-lg">
              ...
              If you have questions, please contact the researcher.<br />
              如有疑问，请联系实验负责人。
            </p>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg max-w-lg w-full overflow-hidden text-center">
        <div className="bg-emerald-600 px-8 py-8 text-white">
          ...
          <h1 className="text-2xl font-bold">Study Completed!</h1>
          <p className="text-emerald-200 text-sm mt-1">实验完成！</p>
        </div>
        <div className="p-8 space-y-4">
          <p className="text-slate-700 text-sm leading-relaxed">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            感谢您参与本研究！您的作答已成功记录，对我们的研究非常有价値。
          </p>
          <div className="mt-4 p-3 bg-slate-50 rounded-lg">
            <p className="text-xs text-slate-400">
              Participant ID: <span className="font-mono font-medium text-slate-600">{participantId}</span>
            </p>
            <p className="text-xs text-slate-400 mt-1">Please share this ID with the researcher to complete the process.</p>
            <p className="text-xs text-slate-400">请将此 ID 告知实验负责人以完成后续流程。</p>
          </div>
        </div>
      </div>
    </div>
